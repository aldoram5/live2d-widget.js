...
import { Live2DAppDelegate, canvas, gl } from './live2dappdelegate';
...
export class LAppView {
  ...
  public initializeSprite(): void {
    ...
    const textureManager = Live2DAppDelegate.getInstance().getTextureManager();

    // シェーダーを作成
    if (this._programId == null) {
      this._programId = Live2DAppDelegate.getInstance().createShader();
    }
  }
